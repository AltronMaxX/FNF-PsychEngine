...
class PlayState extends MusicBeatState
{
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = Language.getPhrase('score_text', 'Score: {1} | Misses: {2} | Rating: {3}', [FlxStringUtil.formatMoney(songScore, false), FlxStringUtil.formatMoney(songMisses, false), str]);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ClientPrefs.data.developerMode && !endingSong && !inCutscene && allowDebugKeys)
		{
